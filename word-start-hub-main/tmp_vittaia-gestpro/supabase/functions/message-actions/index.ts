...
async function getEvolutionConfig(supabaseAdmin: any, organizationId: string): Promise<EvolutionConfig | null> {
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const evolution = await getEvolutionConfig(supabaseAdmin, msg.organization_id);
    if (!evolution) {
