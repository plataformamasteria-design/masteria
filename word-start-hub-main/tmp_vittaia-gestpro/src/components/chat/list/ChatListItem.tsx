...
import { Bot, ArrowRightLeft, CheckCircle2, BotOff, Pin, Users, Facebook, Instagram, PinOff } from 'lucide-react';
        ...
        <ContextMenu>
            ...
            <ContextMenuContent className="w-52">
                <ContextMenuItem
                    ...
                    disabled={!chatIsPinned && pinnedCount >= maxPins}
                >
                    {chatIsPinned ? (
                        <><PinOff className="h-4 w-4 mr-2" /> Desafixar conversa</>
                    ) : (
                        <><Pin className="h-4 w-4 mr-2" /> Fixar conversa{pinnedCount >= maxPins ? ` (${maxPins}/${maxPins})` : ''}</>
                    )}
                </ContextMenuItem>
            </ContextMenuContent>
        </ContextMenu>
