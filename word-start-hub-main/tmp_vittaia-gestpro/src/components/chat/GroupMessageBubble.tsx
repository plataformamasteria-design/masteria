...
import { ChevronDown, Copy, Download, ExternalLink, Eye, FileText, Forward, MapPin, Pencil, Phone, Pin, PinOff, QrCode, Reply, Trash2, User, ZoomIn } from 'lucide-react';
    ...
    >
      <div
        className={cn(
          ...
          isOutgoing
            ? 'bg-primary rounded-tr-sm group-agent-message-bubble'
            : 'bg-card text-card-foreground border border-border rounded-tl-sm group-lead-message-bubble'
        )}
        style={isOutgoing ? {
