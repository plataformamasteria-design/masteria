...
export default function Organizations() {
  ...
  const [clientDataDefaultTab, setClientDataDefaultTab] = useState('webhooks');
        ...
        <Tabs defaultValue="organizations" className="w-full">
          ...
          <TabsContent value="organizations" className="space-y-6 mt-6">
            ...
            <OrgGrid
              ...
              onClientData={(org) => { setSelectedOrg(org); setClientDataDefaultTab('webhooks'); setIsClientDataDialogOpen(true); }}
              onClientUsers={(org) => { setSelectedOrg(org); setClientDataDefaultTab('users'); setIsClientDataDialogOpen(true); }}
            ...
            <OrgClientDataDialog
              key={`${selectedOrg?.id ?? 'none'}-${clientDataDefaultTab}`}
              open={isClientDataDialogOpen}
              onOpenChange={setIsClientDataDialogOpen}
              organization={selectedOrg}
              defaultTab={clientDataDefaultTab}
            />
          </TabsContent>
...
function OrgGrid({
  ...
  onClientUsers: (org: Organization) => void;
