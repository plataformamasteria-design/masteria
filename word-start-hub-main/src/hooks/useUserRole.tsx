...
export function useUserRole() {
  ...
  const checkUserRole = async () => {
    try {
      ...
      const isHidenUser = userRoles.includes('hiden');
      setIsHiden(isHidenUser);
  ...
  return { isAdmin, isSuperAdmin, isSubAdmin, isHiden, isLoading, isImpersonating, stopImpersonating };
}
