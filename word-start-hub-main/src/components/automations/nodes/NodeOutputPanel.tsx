...
export function NodeOutputPanel({ nodeId, nodeLabel, nodeType, output, isPinned, isExecuting, error, onExecute, onPin, onUnpin }: NodeOutputPanelProps) {
  ...
  return (
    <div className="border-t border-border/40">
      ...
      {needsLead && (
        <div className="px-3 py-2 space-y-1.5 border-b border-border/30 nodrag nowheel">
        ...
        <div className="px-3 pb-3 nowheel nodrag">
          {error ? (
            ...
            <Tabs defaultValue="schema" className="w-full">
              ...
              <TabsContent value="schema" className="mt-0 max-h-[280px] overflow-y-auto rounded-lg border border-border/40 bg-muted/30 p-1">
                <SchemaView data={output} nodeLabel={nodeLabel} nodeId={nodeId} />
              </TabsContent>
              <TabsContent value="json" className="mt-0 max-h-[200px] overflow-y-auto rounded-lg border border-border/40 bg-zinc-950 p-2">
