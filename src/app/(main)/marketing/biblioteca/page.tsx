  ...
  return (
    <div className="space-y-6 animate-in slide-in-from-bottom-4 duration-700 fade-in">
      <div className="flex flex-col bg-card/40 border border-border/50 p-5 rounded-2xl">
        ...
        <p className="text-muted-foreground text-sm mt-1">Imagens e vídeos da conta de anúncios</p>
      </div>
      ...
      <Card className="border-dashed border-border/50">
        <CardContent className="py-16 flex flex-col items-center gap-4 text-center">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">A biblioteca de mídias estará disponível em breve.</p>
          </div>
        </CardContent>
      </Card>
    </div>
