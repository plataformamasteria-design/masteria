// src/components/roadmap/page.tsx
'use client';
import { PageHeader } from '@/components/page-header';
import { Card, CardContent, CardHeader, CardTitle, CardDescription } from '@/components/ui/card';
import { Lightbulb, Rocket, Bot, GitBranch, Mail, Handshake, LayoutDashboard, History } from 'lucide-react';
import { Button } from '@/components/ui/button';

const futureFeatures = [
    { 
        icon: Bot, 
        title: 'Funcionalidades de IA (Genkit)',
        description: 'Reativação da criação de Personas de IA, Roteamento de Atendimentos e personalização de mensagens com IA.'
    },
    {
        icon: GitBranch,
