...
export const WaitResponseNode = memo(({ data, selected }: any) => {
    return (
        <div
            className={`px-5 py-4 shadow-[0_4px_24px_rgba(0,0,0,0.06)] rounded-2xl bg-white dark:bg-zinc-900 border ${selected ? 'border-teal-500' : 'border-teal-500/20'} min-w-[280px] max-w-[320px]  animate-in zoom-in duration-200 group/node relative transition-all`}
        >
            <Handle
                type="target"
            ...
            <div className="bg-gray-50 dark:bg-zinc-900/80 p-3 rounded-xl border border-gray-100 dark:border-zinc-800/80">
                <div className="flex items-center justify-center gap-2 py-2">
                    ...
                    <span className="text-xs text-teal-600 dark:text-teal-400 font-semibold">Aguardando...</span>
                </div>
                {data.timeout_minutes && (
                    <div className="flex items-center gap-1.5 mt-2 justify-center text-gray-400 dark:text-zinc-400">
