        ...
        return (
            <div className="w-full h-full flex items-center justify-center bg-[#fafafa]">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <p className="text-gray-400 font-medium tracking-wide text-xs">Carregando fluxo...</p>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="w-full h-full relative group">
            <ReactFlow
                ...
                className="!bg-[#fafafa]"
            >
                <Controls position="bottom-left" className="!bg-white !border !border-gray-100 !text-gray-500 !shadow-sm !m-6 !rounded-xl overflow-hidden [&>button]:!bg-transparent [&>button]:!border-gray-100 [&>button]:!text-gray-400 [&>button:hover]:!bg-gray-50 [&>button:hover]:!text-gray-600" />
                <MiniMap position="bottom-right" className="!bg-white !border !border-gray-100 !shadow-sm !rounded-xl overflow-hidden !mb-8 !mr-8" maskColor="rgba(250,250,250,0.7)" nodeColor="#6366f1" />
                    ...
                    <>
                        ...
                        >
                            ...
                            <div className="flex items-center justify-between px-6 py-4 border-b border-zinc-100 bg-white/60 shrink-0">
                                ...
                                <div className="flex items-center gap-2">
                                    <Button
                                        variant="outline"
                                        size="sm"
                                        className="text-xs h-8 rounded-lg border-gray-200 hover:bg-gray-50"
                                        onClick={() => setEditingNode(null)}
                                    >
                                        ✕ Fechar
                                    </Button>
                            ...
                            <div className="flex-1 flex min-h-0 overflow-hidden">
                                ...
                                <div
                                    className="border-r border-gray-100 overflow-y-auto custom-scrollbar bg-white shrink-0"
                                ...
                                <div className="flex-1 overflow-y-auto custom-scrollbar bg-[#fafafa] min-w-0">
                                    <div className="px-6 py-3 border-b border-gray-100 bg-white sticky top-0 z-10">
                                        <div className="flex gap-1">
                                            ...
                                            <button className="px-3 py-1.5 text-[11px] font-medium text-gray-400 border-b-2 border-transparent hover:text-gray-600">Configurações</button>
                                        </div>
                                    </div>
                                ...
                                <div
                                    className="border-l border-gray-100 overflow-y-auto custom-scrollbar bg-white shrink-0"
                ...
                <Panel position="top-left" className="p-4">
                    <div className="bg-white p-1.5 px-3 rounded-xl border border-gray-100 flex gap-3 shadow-sm items-center">
                        ...
                        <Input
                            ...
                            className="bg-transparent border-0 font-semibold text-gray-900 focus-visible:ring-0 w-[220px] px-0 text-[13px] placeholder:text-gray-300"
                ...
                <Panel position="top-right" className="p-4">
                    <div className="bg-white p-1 rounded-xl border border-gray-100 flex gap-1.5 shadow-sm items-center">
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                <Button variant="secondary" size="sm" className="bg-gray-50 hover:bg-gray-100 text-gray-700 border-0 text-xs h-8 gap-1.5 px-3 rounded-lg transition-all active:scale-95 font-medium">
                            ...
                            <DropdownMenuContent align="end" className="w-[340px] bg-white/95 backdrop-blur-xl border border-gray-200/60 rounded-2xl shadow-2xl p-3 max-h-[80vh] overflow-y-auto custom-scrollbar grid grid-cols-2 gap-2">
                                {/* === MENSAGENS === */}
                                <DropdownMenuSeparator className="bg-gray-100 my-1 col-span-2" />
                                <DropdownMenuLabel className="px-3 py-1.5 text-[10px] font-semibold uppercase tracking-widest text-gray-400 col-span-2">Mensagens</DropdownMenuLabel>
                                <DropdownMenuItem onClick={() => addNode('send_message', { message: '' })} className="rounded-lg focus:bg-gray-50 text-gray-600 cursor-pointer py-2 text-[13px]">
                                    <MessageSquare className="mr-2.5 h-4 w-4 text-green-500" /> WhatsApp
                                </DropdownMenuItem>
                                <DropdownMenuItem onClick={() => addNode('send_template', { template_name: '' })} className="rounded-lg focus:bg-gray-50 text-gray-600 cursor-pointer py-2 text-[13px]">
                                    <MessageSquareShare className="mr-2.5 h-4 w-4 text-green-600" /> Template WhatsApp
                                </DropdownMenuItem>
                                <DropdownMenuItem onClick={() => addNode('send_image', { url: '' })} className="rounded-lg focus:bg-gray-50 text-gray-600 cursor-pointer py-2 text-[13px]">
                                    <ImageIcon className="mr-2.5 h-4 w-4 text-blue-500" /> Imagem
                                </DropdownMenuItem>
                                <DropdownMenuItem onClick={() => addNode('send_audio', { url: '' })} className="rounded-lg focus:bg-gray-50 text-gray-600 cursor-pointer py-2 text-[13px]">
                                    <Mic className="mr-2.5 h-4 w-4 text-pink-500" /> Áudio
                                </DropdownMenuItem>

                                {/* === LÓGICA E CONTROLE === */}
                                <DropdownMenuSeparator className="bg-gray-100 my-1 col-span-2" />
                                <DropdownMenuLabel className="px-3 py-1.5 text-[10px] font-semibold uppercase tracking-widest text-gray-400 col-span-2">Lógica e Controle</DropdownMenuLabel>
                                <DropdownMenuItem onClick={() => addNode('condition', { conditions: [] })} className="rounded-lg focus:bg-gray-50 text-gray-600 cursor-pointer py-2 text-[13px]">
                                    <GitBranch className="mr-2.5 h-4 w-4 text-indigo-500" /> Condição (Se)
                                </DropdownMenuItem>
                                <DropdownMenuItem onClick={() => addNode('delay', { amount: 1, unit: 'minutes' })} className="rounded-lg focus:bg-gray-50 text-gray-600 cursor-pointer py-2 text-[13px]">
                                    <Clock className="mr-2.5 h-4 w-4 text-amber-500" /> Atraso (Delay)
                                </DropdownMenuItem>
                                <DropdownMenuItem onClick={() => addNode('wait_response', { maxWaitTime: 10 })} className="rounded-lg focus:bg-gray-50 text-gray-600 cursor-pointer py-2 text-[13px]">
                                    <Clock className="mr-2.5 h-4 w-4 text-teal-500" /> Esperar Resposta
                                </DropdownMenuItem>

                                {/* === CRM E SUPORTE === */}
                                <DropdownMenuSeparator className="bg-gray-100 my-1 col-span-2" />
                                <DropdownMenuLabel className="px-3 py-1.5 text-[10px] font-semibold uppercase tracking-widest text-gray-400 col-span-2">CRM & Suporte</DropdownMenuLabel>
                                <DropdownMenuItem onClick={() => addNode('lookup_lead', { identifier_type: 'phone' })} className="rounded-lg focus:bg-gray-50 text-gray-600 cursor-pointer py-2 text-[13px]">
                                    <UserSearch className="mr-2.5 h-4 w-4 text-indigo-400" /> Buscar Lead
                                </DropdownMenuItem>
                                <DropdownMenuItem onClick={() => addNode('assign_user', { assign_type: 'user' })} className="rounded-lg focus:bg-gray-50 text-gray-600 cursor-pointer py-2 text-[13px]">
                                    <UserPlus className="mr-2.5 h-4 w-4 text-fuchsia-500" /> Atribuir Lead
                                </DropdownMenuItem>
                                <DropdownMenuItem onClick={() => addNode('add_note', { note: '' })} className="rounded-lg focus:bg-gray-50 text-gray-600 cursor-pointer py-2 text-[13px]">
                                    <StickyNote className="mr-2.5 h-4 w-4 text-amber-500" /> Adicionar Nota
                                </DropdownMenuItem>
                                <DropdownMenuItem onClick={() => addNode('crm_move', { boardId: '', pipelineId: '' })} className="rounded-lg focus:bg-gray-50 text-gray-600 cursor-pointer py-2 text-[13px]">
                                    <Columns3 className="mr-2.5 h-4 w-4 text-orange-500" /> Mover Kanban
                                </DropdownMenuItem>
                                <DropdownMenuItem onClick={() => addNode('add_tag', { tagId: '' })} className="rounded-lg focus:bg-gray-50 text-gray-600 cursor-pointer py-2 text-[13px]">
                                    <Hash className="mr-2.5 h-4 w-4 text-rose-500" /> Adicionar Tag
                                </DropdownMenuItem>
                                <DropdownMenuItem onClick={() => addNode('bot_toggle', { action: 'stop' })} className="rounded-lg focus:bg-gray-50 text-gray-600 cursor-pointer py-2 text-[13px]">
                                    <UserPlus className="mr-2.5 h-4 w-4 text-cyan-500" /> Parar Robô
                                </DropdownMenuItem>
                                <DropdownMenuItem onClick={() => addNode('capture_info', { fieldInfo: '' })} className="rounded-lg focus:bg-gray-50 text-gray-600 cursor-pointer py-2 text-[13px]">
                                    <Database className="mr-2.5 h-4 w-4 text-blue-400" /> Capturar Dado
                                </DropdownMenuItem>

                                {/* === OUTROS (AI/AVANÇADO) === */}
                                <DropdownMenuSeparator className="bg-gray-100 my-1 col-span-2" />
                                <DropdownMenuLabel className="px-3 py-1.5 text-[10px] font-semibold uppercase tracking-widest text-gray-400 col-span-2">Inteligência I.A</DropdownMenuLabel>
                                <DropdownMenuItem onClick={() => addNode('ai_agent', { provider: 'gemini', model: 'gemini-2.0-flash' })} className="rounded-lg focus:bg-gray-50 text-gray-600 cursor-pointer py-2 text-[13px]">
                                    <Brain className="mr-2.5 h-4 w-4 text-violet-500" /> Agente I.A
                                </DropdownMenuItem>
                                <DropdownMenuItem onClick={() => addNode('intent_router', { intents: [] })} className="rounded-lg focus:bg-gray-50 text-gray-600 cursor-pointer py-2 text-[13px]">
                                    <Signpost className="mr-2.5 h-4 w-4 text-purple-500" /> Classificador
                                </DropdownMenuItem>
                                <DropdownMenuItem onClick={() => addNode('follow_up_ai', {})} className="rounded-lg focus:bg-gray-50 text-gray-600 cursor-pointer py-2 text-[13px]">
                                    <MessageSquareHeart className="mr-2.5 h-4 w-4 text-orange-500" /> Follow Up
                                </DropdownMenuItem>
                                <DropdownMenuItem onClick={() => addNode('send_ai_response', {})} className="rounded-lg focus:bg-gray-50 text-gray-600 cursor-pointer py-2 text-[13px]">
                                    <Send className="mr-2.5 h-4 w-4 text-emerald-500" /> Resposta I.A
                                </DropdownMenuItem>

                                <DropdownMenuSeparator className="bg-gray-100 my-1" />
                                <DropdownMenuLabel className="px-3 py-1.5 text-[10px] font-semibold uppercase tracking-widest text-gray-400">Avançado</DropdownMenuLabel>
                                <DropdownMenuItem onClick={() => addNode('http_request', { method: 'GET', url: '' })} className="rounded-lg focus:bg-gray-50 text-gray-600 cursor-pointer py-2 text-[13px]">
                                    <Globe className="mr-2.5 h-4 w-4 text-sky-500" /> HTTP Request
                                </DropdownMenuItem>
                                <DropdownMenuItem onClick={() => addNode('code', { language: 'javascript', code: '' })} className="rounded-lg focus:bg-gray-50 text-gray-600 cursor-pointer py-2 text-[13px]">
                                    <Code2 className="mr-2.5 h-4 w-4 text-gray-500" /> Código
                                </DropdownMenuItem>
                                <DropdownMenuItem onClick={() => addNode('edit_fields', { fields: [], mode: 'pairs' })} className="rounded-lg focus:bg-gray-50 text-gray-600 cursor-pointer py-2 text-[13px]">
                                    <PenLine className="mr-2.5 h-4 w-4 text-teal-500" /> Edit Fields
                                </DropdownMenuItem>
                            </DropdownMenuContent>
                        </DropdownMenu>

                        <div className="w-[1px] h-5 bg-gray-100 mx-0.5" />

                        <Button
                            size="sm"
                            variant="secondary"
                            onClick={handleAutoLayout}
                            className="bg-gray-50 hover:bg-gray-100 text-gray-500 border-0 text-xs h-8 px-2.5 rounded-lg transition-all active:scale-95 font-medium"
            ...
            {showFlowTestResults && Object.keys(testOutputs).length > 0 && (
                <div className="absolute bottom-0 left-0 right-0 bg-white border-t border-gray-100 shadow-xl z-50 max-h-[250px] overflow-hidden flex flex-col animate-in slide-in-from-bottom duration-200">
                    <div className="flex items-center justify-between px-4 py-2 bg-gray-50/50 border-b border-gray-50">
                        <div className="flex items-center gap-2">
                            <Play className="h-3.5 w-3.5 text-emerald-500" />
                            <span className="text-xs font-semibold text-gray-600">Resultado do Teste</span>
                            <span className="text-[10px] text-gray-400">{Object.keys(testOutputs).length} nós</span>
                        </div>
                        <div className="flex items-center gap-2">
                            <button onClick={clearOutputs} className="text-[10px] text-gray-400 hover:text-gray-600 transition-colors">Limpar</button>
                            <button onClick={() => setShowFlowTestResults(false)} className="text-xs text-gray-400 hover:text-gray-600 transition-colors">✕</button>
                        </div>
                    </div>
                            ...
                            {Object.values(testOutputs).map((out, i) => (
                                <div key={out.nodeId} className="w-[220px] shrink-0 border-r border-gray-50 p-3">
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <span className="text-[11px] font-semibold text-gray-700 truncate">{out.nodeLabel}</span>
                                        <span className="text-[9px] text-gray-300 ml-auto">{out.executionTime}ms</span>
                                    </div>
                                    <pre className="text-[10px] font-mono text-gray-500 bg-gray-50 p-2 rounded-lg overflow-auto max-h-[120px] whitespace-pre-wrap break-all">
                        ...
                        <div className="bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden">
                            ...
                            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-50 bg-gradient-to-r from-amber-50/70 to-orange-50/70">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="font-semibold text-gray-900 text-sm">Gerar Workflow com IA</h3>
                                        <p className="text-[11px] text-gray-400">Descreva o que deseja e a IA cria o fluxo completo</p>
                                    </div>
                                </div>
                                <button
                                    onClick={() => !isGeneratingAI && setAiPromptOpen(false)}
                            ...
                            <div className="p-6">
                                <Textarea
                                    ...
                                    className="min-h-[140px] resize-none border-gray-200 rounded-xl text-sm placeholder:text-gray-300 focus-visible:ring-amber-400/30 focus-visible:border-amber-400"
                                ...
                                <div className="flex items-center justify-between mt-4">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <Button
                                            ...
                                            disabled={isGeneratingAI}
                                            className="text-gray-400 hover:text-gray-600 text-xs h-8 rounded-lg"
                                        >
                                            Cancelar
                                        </Button>
                                        <Button
                ...
                <>
                    ...
                    >
                        <div className="flex items-center justify-between pb-2 mb-2 border-b border-gray-100">
                            <span className="text-[11px] font-semibold text-gray-500 tracking-wider uppercase">Adicionar Nó</span>
                            <button onClick={() => setMenuPosition(null)} className="text-gray-400 hover:text-gray-600 bg-gray-50 hover:bg-gray-100 p-1 rounded-sm transition-colors"><XIcon className="h-3.5 w-3.5" /></button>
                        </div>

                        <div className="grid grid-cols-2 gap-2">
                            <div className="col-span-2">
                                <span className="px-1 py-1.5 text-[10px] font-semibold uppercase tracking-widest text-gray-400">Mensagens</span>
                            </div>
                            <button onClick={() => addNode('send_message', { message: '' })} className="flex items-center rounded-lg hover:bg-gray-50 text-gray-600 cursor-pointer py-2 px-2 text-[13px] text-left transition-colors">
                                <MessageSquare className="mr-2.5 h-4 w-4 text-green-500 flex-shrink-0" /> WhatsApp
                            </button>
                            <button onClick={() => addNode('send_template', { template_name: '' })} className="flex items-center rounded-lg hover:bg-gray-50 text-gray-600 cursor-pointer py-2 px-2 text-[13px] text-left transition-colors">
                                <MessageSquareShare className="mr-2.5 h-4 w-4 text-green-600 flex-shrink-0" /> Template WhatsApp
                            </button>
                            <button onClick={() => addNode('send_image', { url: '' })} className="flex items-center rounded-lg hover:bg-gray-50 text-gray-600 cursor-pointer py-2 px-2 text-[13px] text-left transition-colors">
                                <ImageIcon className="mr-2.5 h-4 w-4 text-blue-500 flex-shrink-0" /> Imagem
                            </button>
                            <button onClick={() => addNode('send_audio', { url: '' })} className="flex items-center rounded-lg hover:bg-gray-50 text-gray-600 cursor-pointer py-2 px-2 text-[13px] text-left transition-colors">
                            ...
                            <div className="col-span-2 mt-1 border-t border-gray-100 pt-2">
                                <span className="px-1 py-1.5 text-[10px] font-semibold uppercase tracking-widest text-gray-400">Lógica e Controle</span>
                            </div>
                            <button onClick={() => addNode('condition', { conditions: [] })} className="flex items-center rounded-lg hover:bg-gray-50 text-gray-600 cursor-pointer py-2 px-2 text-[13px] text-left transition-colors">
                                <GitBranch className="mr-2.5 h-4 w-4 text-indigo-500 flex-shrink-0" /> Condição (Se)
                            </button>
                            <button onClick={() => addNode('delay', { amount: 1, unit: 'minutes' })} className="flex items-center rounded-lg hover:bg-gray-50 text-gray-600 cursor-pointer py-2 px-2 text-[13px] text-left transition-colors">
                                <Clock className="mr-2.5 h-4 w-4 text-amber-500 flex-shrink-0" /> Atraso (Delay)
                            </button>
                            <button onClick={() => addNode('wait_response', { maxWaitTime: 10 })} className="flex items-center rounded-lg hover:bg-gray-50 text-gray-600 cursor-pointer py-2 px-2 text-[13px] text-left transition-colors">
                                <Clock className="mr-2.5 h-4 w-4 text-teal-500 flex-shrink-0" /> Esperar Resposta
                            </button>

                            <div className="col-span-2 mt-1 border-t border-gray-100 pt-2">
                                <span className="px-1 py-1.5 text-[10px] font-semibold uppercase tracking-widest text-gray-400">CRM & Suporte</span>
                            </div>
                            <button onClick={() => addNode('lookup_lead', { identifier_type: 'phone' })} className="flex items-center rounded-lg hover:bg-gray-50 text-gray-600 cursor-pointer py-2 px-2 text-[13px] text-left transition-colors">
                                <UserSearch className="mr-2.5 h-4 w-4 text-indigo-400 flex-shrink-0" /> Buscar Lead
                            </button>
                            <button onClick={() => addNode('assign_user', { assign_type: 'user' })} className="flex items-center rounded-lg hover:bg-gray-50 text-gray-600 cursor-pointer py-2 px-2 text-[13px] text-left transition-colors">
                                <UserPlus className="mr-2.5 h-4 w-4 text-fuchsia-500 flex-shrink-0" /> Atribuir Lead
                            </button>
                            <button onClick={() => addNode('add_note', { note: '' })} className="flex items-center rounded-lg hover:bg-gray-50 text-gray-600 cursor-pointer py-2 px-2 text-[13px] text-left transition-colors">
                                <StickyNote className="mr-2.5 h-4 w-4 text-amber-500 flex-shrink-0" /> Adicionar Nota
                            </button>
                            <button onClick={() => addNode('crm_move', { boardId: '', pipelineId: '' })} className="flex items-center rounded-lg hover:bg-gray-50 text-gray-600 cursor-pointer py-2 px-2 text-[13px] text-left transition-colors">
                                <Columns3 className="mr-2.5 h-4 w-4 text-orange-500 flex-shrink-0" /> Mover Kanban
                            </button>
                            <button onClick={() => addNode('add_tag', { tagId: '' })} className="flex items-center rounded-lg hover:bg-gray-50 text-gray-600 cursor-pointer py-2 px-2 text-[13px] text-left transition-colors">
                                <Hash className="mr-2.5 h-4 w-4 text-rose-500 flex-shrink-0" /> Adicionar Tag
                            </button>
                            <button onClick={() => addNode('bot_toggle', { action: 'stop' })} className="flex items-center rounded-lg hover:bg-gray-50 text-gray-600 cursor-pointer py-2 px-2 text-[13px] text-left transition-colors">
                                <UserPlus className="mr-2.5 h-4 w-4 text-cyan-500 flex-shrink-0" /> Parar Robô
                            </button>
                            <button onClick={() => addNode('capture_info', { fieldInfo: '' })} className="flex items-center rounded-lg hover:bg-gray-50 text-gray-600 cursor-pointer py-2 px-2 text-[13px] text-left transition-colors">
                                <Database className="mr-2.5 h-4 w-4 text-blue-400 flex-shrink-0" /> Capturar Dado
                            </button>

                            <div className="col-span-2 mt-1 border-t border-gray-100 pt-2">
                                <span className="px-1 py-1.5 text-[10px] font-semibold uppercase tracking-widest text-gray-400">Inteligência I.A</span>
                            </div>
                            <button onClick={() => addNode('ai_agent', { provider: 'gemini', model: 'gemini-2.0-flash' })} className="flex items-center rounded-lg hover:bg-gray-50 text-gray-600 cursor-pointer py-2 px-2 text-[13px] text-left transition-colors">
                                <Brain className="mr-2.5 h-4 w-4 text-violet-500 flex-shrink-0" /> Agente I.A
                            </button>
                            <button onClick={() => addNode('intent_router', { intents: [] })} className="flex items-center rounded-lg hover:bg-gray-50 text-gray-600 cursor-pointer py-2 px-2 text-[13px] text-left transition-colors">
                                <Signpost className="mr-2.5 h-4 w-4 text-purple-500 flex-shrink-0" /> Classificador
                            </button>
                            <button onClick={() => addNode('follow_up_ai', {})} className="flex items-center rounded-lg hover:bg-gray-50 text-gray-600 cursor-pointer py-2 px-2 text-[13px] text-left transition-colors">
                                <MessageSquareHeart className="mr-2.5 h-4 w-4 text-orange-500 flex-shrink-0" /> Follow Up
                            </button>
                            <button onClick={() => addNode('send_ai_response', {})} className="flex items-center rounded-lg hover:bg-gray-50 text-gray-600 cursor-pointer py-2 px-2 text-[13px] text-left transition-colors">
                                <Send className="mr-2.5 h-4 w-4 text-emerald-500 flex-shrink-0" /> Resposta I.A
                            </button>

                            <div className="col-span-2 mt-1 border-t border-gray-100 pt-2">
                                <span className="px-1 py-1.5 text-[10px] font-semibold uppercase tracking-widest text-gray-400">Avançado</span>
                            </div>
                            <button onClick={() => addNode('http_request', { method: 'GET', url: '' })} className="flex items-center rounded-lg hover:bg-gray-50 text-gray-600 cursor-pointer py-2 px-2 text-[13px] text-left transition-colors">
                                <Globe className="mr-2.5 h-4 w-4 text-sky-500 flex-shrink-0" /> HTTP Request
                            </button>
                            <button onClick={() => addNode('code', { language: 'javascript', code: '' })} className="flex items-center rounded-lg hover:bg-gray-50 text-gray-600 cursor-pointer py-2 px-2 text-[13px] text-left transition-colors">
                                <Code2 className="mr-2.5 h-4 w-4 text-gray-500 flex-shrink-0" /> Código
                            </button>
                            <button onClick={() => addNode('edit_fields', { fields: [], mode: 'pairs' })} className="flex items-center rounded-lg hover:bg-gray-50 text-gray-600 cursor-pointer py-2 px-2 text-[13px] text-left transition-colors">
