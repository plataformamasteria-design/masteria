...
exports.enqueueMessageTrigger = enqueueMessageTrigger;
var bullmq_1 = require("bullmq");
var redis_connection_1 = require("../redis-connection");
exports.WEBHOOK_QUEUE_NAME = 'webhook-processing-queue';
// Singleton instance of the queue
var webhookQueue = null;
function getWebhookQueue() {
    if (!webhookQueue) {
        var connection = (0, redis_connection_1.createRedisConnection)();
        if (!connection) {
 ...
 */
function enqueueMessageTrigger(conversationId, messageId) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, queue.add('process-incoming-message', { conversationId: conversationId, messageId: messageId }, { jobId: "msg-".concat(messageId) })];
                case 1:
                    // Use messageId as jobId to provide native BullMQ idempotency.
                    // If the same messageId is pushed while it's already waiting, it's ignored or deduplicated.
                    _a.sent();
