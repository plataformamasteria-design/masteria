...
async function main() {
    try {
        ...
        const fieldsToAdd = [
            ...
            { name: 'objetivo', value: '{{body.respondent.answers.Qual o seu principal objetivo no Evento Gestão com Resultado?}}' },
            { name: 'opcao_investimento', value: '{{body.respondent.answers.O Evento Gestão com Resultado é um evento presencial que acontece no Alphaville SP, valor do Investimento é a partir R$ 1497, qual opção você prefere?}}' },
